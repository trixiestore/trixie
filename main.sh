...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To TRIXIE STORE TUNNELING SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}TRIXIE TUNNELING ® ${NC}${YELLOW}(${NC} ${green} TRIXIE STORE TUNNELING ${NC}${YELLOW})${NC}"
echo -e " © Recode By My Self KARANGANYAR TUNNEL ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/trixiestore/trixie/main/"
...
clear
izinsc="https://raw.githubusercontent.com/trixiestore/izin/main/ipvps"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/trixiestore/trixie/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
